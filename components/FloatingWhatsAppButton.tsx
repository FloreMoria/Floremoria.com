...
export default function FloatingWhatsAppButton() {
    ...
    return (
        <a
            ...
            className="hidden md:inline-flex fixed right-1 top-20 sm:right-6 sm:top-24 z-[9999] h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_24px_rgba(37,211,102,0.35)] transition-transform duration-200 hover:scale-105 hover:shadow-[0_14px_28px_rgba(37,211,102,0.42)] focus:outline-none focus:ring-2 focus:ring-[#25D366]/60 focus:ring-offset-2"
        >
