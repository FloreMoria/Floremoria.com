...
export default function ClientActivateForm({ token }: Props) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok && data.success) {
                ...
                setErrorMsg(data.message || 'Errore durante l\'attivazione dell\'account.');
            }
        } catch {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
                {isSubmitting ? 'Attivazione in corso...' : 'Attiva Account & Accedi'}
            </button>
        </form>
    );
}
