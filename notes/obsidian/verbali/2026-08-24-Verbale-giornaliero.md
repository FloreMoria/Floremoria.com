...
sync_source: docs/verbali/24-08-2026.md
synced_at: 2026-08-25T04:27:31.262Z
---

> Copia sincronizzata automaticamente da `docs/verbali/24-08-2026.md`. Modificare la fonte in `docs/verbali/`; rieseguire `npm run log:verbale:sync-docs`.
