...
export default function AssistenzaPage() {
    return (
        <div className="space-y-10 lg:space-y-14 pb-8">

            {/* 1. HERO & TITOLO PAGINA */}
            <section className="text-center space-y-4 max-w-4xl mx-auto pt-5 relative">
                ...
                <h1 className="text-3xl md:text-[48px] font-display font-bold text-gray-900 leading-tight tracking-wide">
            ...
            {/* 2. GUIDA IN 3 STEP */}
            <section className="max-w-6xl mx-auto bg-white rounded-[24px] shadow-sm border border-fm-rose-soft/30 p-5 sm:p-6 lg:p-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 text-center">
                    {/* Step 1 */}
                    <div className="flex flex-col items-center space-y-3">
                        <div className="w-12 h-12 rounded-full bg-fm-gold/10 flex items-center justify-center text-fm-gold">
                            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                            </svg>
                        </div>
                        <h3 className="text-lg font-display font-bold text-gray-900">Scegli l&apos;omaggio</h3>
                        <p className="text-sm sm:text-base text-fm-muted font-body">Seleziona il bouquet o l&apos;accessorio più adatto al tuo messaggio.</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center space-y-3">
                        ...
                        <h3 className="text-lg font-display font-bold text-gray-900">Personalizza il messaggio</h3>
                        <p className="text-sm sm:text-base text-fm-muted font-body">Aggiungi i dati e il tuo pensiero dedicato in fase di checkout.</p>
                    </div>
            ...
            <section className="max-w-5xl mx-auto space-y-4">
                ...
                <div className="bg-white/90 backdrop-blur-xl border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[26px] p-5 sm:p-6 lg:p-10 relative overflow-hidden">
                    {/* Glow Oro Etereo */}
                    ...
                    <div className="text-center space-y-3 mb-8 relative z-10">
                        <h2 className="text-2xl md:text-[34px] font-display font-medium text-gray-900 tracking-wide leading-tight">
                            Il tuo pensiero, sempre presente.
                        </h2>
                        <p className="text-base sm:text-lg text-gray-600 font-body max-w-2xl mx-auto leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 relative z-10">
                            ...
                            <div className="flex flex-row md:flex-col items-start md:items-center text-left md:text-center space-x-6 md:space-x-0 relative">
                                ...
                                <div className="pt-2 md:pt-0">
                                    <h3 className="text-xl font-display font-medium text-gray-900 mb-2">Il Primo Scatto (opzionale):<br className="hidden md:block" /> Tomba prima della posa</h3>
                                    <p className="text-gray-600 font-body font-light text-base leading-relaxed md:px-2">
                                        Per gli omaggi sulle tombe, puoi aggiungere una foto dello stato attuale prima della posa. Questo scatto &egrave; un extra a pagamento, utile se desideri un confronto completo prima/dopo.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-row md:flex-col items-start md:items-center text-left md:text-center space-x-6 md:space-x-0 relative">
                                ...
                                <div className="pt-2 md:pt-0">
                                    <h3 className="text-xl font-display font-medium text-gray-900 mb-2">Il Secondo Scatto (incluso):<br className="hidden md:block" /> Fiori posati e consegna confermata</h3>
                                    <p className="text-gray-600 font-body font-light text-base leading-relaxed md:px-2">
                                        La foto finale dei fiori gi&agrave; posati &egrave; sempre inclusa gratuitamente: &egrave; la conferma visiva della consegna effettuata. Per i servizi Funerale e Piccoli Amici non &egrave; prevista la foto pre-posa.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-fm-eucalyptus/5 lg:w-[85%] mx-auto rounded-[20px] p-5 sm:p-6 lg:p-8 border border-fm-eucalyptus/10 text-center shadow-inner relative overflow-hidden mb-7">
                        <svg className="absolute -top-6 -right-6 w-24 h-24 text-fm-eucalyptus/10 rotate-[15deg]" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M17,8C8,10 5.9,16.17 3.82,21.34L5.71,22L6.66,19.7C7.14,19.87 7.64,20 8,20C19,20 22,3 22,3C21,5 14,5.25 9,6.25C4,7.25 7,11.5 7,11.5C7,11.5 10.5,12 14,11.5C17.5,11 17,8 17,8Z" />
                        </svg>
                        <h3 className="text-lg md:text-xl font-display font-medium text-fm-gold mb-2 tracking-wide">La Veglia Continua</h3>
                        <p className="text-gray-700 font-body text-base sm:text-lg md:text-xl italic font-light leading-relaxed">
                            "FloreMoria non consegna solo fiori, custodisce la tua presenza."
                        </p>
                    </div>

                    {/* La firma del CEO */}
                    <div className="text-center max-w-2xl mx-auto border-t border-gray-100 pt-5 mt-5">
                        <p className="text-gray-600 font-body text-base sm:text-lg italic leading-relaxed mb-3">
                ...
                <div className="pt-4 pb-1 text-center">
                    <Link href="/fiori-sulle-tombe" className="inline-block bg-fm-gold text-white font-medium text-base sm:text-lg rounded-full px-8 sm:px-10 py-3 hover:shadow-lg hover:bg-yellow-600 hover:-translate-y-0.5 transition-all duration-300">
            ...
            <section className="max-w-4xl mx-auto space-y-5">
                <div className="text-center">
                    <h2 className="text-2xl sm:text-3xl font-display font-bold text-gray-900">Domande Frequenti</h2>
                </div>
                ...
                />
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5 text-left items-start">
                    ...
                    <div className="space-y-4">
                        <details name="faqGroup" className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md overflow-hidden open:ring-1 open:ring-fm-gold/30 open:bg-[#FAF9F6]/80 transition-all duration-300">
                            <summary className="flex items-start md:items-center justify-between cursor-pointer p-4 sm:p-5 font-display font-semibold text-base sm:text-lg text-gray-900 list-none select-none">
                            ...
                            <div className="p-4 sm:p-5 pt-0 text-gray-600 font-body border-t border-fm-gold/10 leading-relaxed text-[15px] sm:text-base">
            ...
            {/* 4. CONTATTI E FORM */}
            <section className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-7 lg:gap-10">

                {/* Dati Contatto */}
                <div className="space-y-5 flex flex-col justify-center">
                    <div>
                        <h2 className="text-[28px] sm:text-[32px] font-display font-bold text-gray-900 leading-snug">Parla con noi</h2>
                        <p className="text-fm-muted text-base sm:text-lg font-body mt-1">Siamo disponibili tutti i giorni per assisterti.</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+393204105305" className="text-lg sm:text-xl font-display font-semibold text-gray-900 hover:text-fm-gold transition-colors">+39 320 410 5305</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <a href="https://wa.me/393204105305" target="_blank" rel="noopener noreferrer" className="text-lg sm:text-xl font-display font-semibold text-gray-900 hover:text-fm-gold transition-colors">+39 320 410 5305</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:assistenza@floremoria.com" className="text-lg sm:text-xl font-display font-semibold text-gray-900 hover:text-fm-gold transition-colors">assistenza@floremoria.com</a>
                            </div>
                        </div>
            ...
            />
            <section className="max-w-4xl mx-auto bg-fm-gold/10 p-5 sm:p-6 lg:p-8 rounded-[24px] border border-fm-gold/20 text-center space-y-4">
                <svg className="w-10 h-10 mx-auto text-fm-gold mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <h3 className="text-xl sm:text-2xl font-display font-semibold text-gray-900">Il Calendario della Memoria</h3>
                <p className="text-base sm:text-lg text-gray-700 max-w-xl mx-auto font-body">
                ...
                <form className="flex flex-col sm:flex-row max-w-md mx-auto gap-2.5 pt-1">
                    <input type="email" placeholder="La tua email" className="flex-1 bg-white border border-fm-gold/30 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-fm-gold shadow-sm" />
            ...
            <section className="text-center pt-5 border-t border-gray-100 pb-6 tracking-wide">
                <p className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-widest mb-4">FLOREMORIA S.R.L.</p>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto text-xs sm:text-sm text-gray-500 leading-relaxed text-center sm:text-left md:text-center">
                    <div>
