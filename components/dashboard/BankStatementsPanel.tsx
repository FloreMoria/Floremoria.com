            ...
            >
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                    <div className="flex items-center gap-3 text-sm text-slate-600">
                        ...
                        <span>
                            Trascina qui il rendiconto ufficiale scaricato dal portale banca
                            (PDF, CSV, Excel — max 15 MB). Devono risultare saldo iniziale e
                            finale dichiarati; l&apos;incolla testo non è ammesso.
                        </span>
                    </div>
