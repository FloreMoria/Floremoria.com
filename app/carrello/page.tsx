...
export default function CartPage() {
    ...
    const cartCategoryState = getCartCatalogCategoryState(cartItems);
    const isMixedCategoryCart = cartCategoryState.kind === 'mixed';
    const canProceedCheckout = hasBouquet && !isMixedCategoryCart;
        ...
        <div className="max-w-4xl mx-auto px-4 py-20 lg:py-32 min-h-[70vh]">
            ...
            {cartItems.length === 0 ? (
                <div className="bg-white rounded-2xl p-10 text-center border border-gray-100 shadow-sm">
                    ...
                    <Link href="/#tre-porte" className="inline-block bg-fm-cta hover:bg-fm-cta-hover text-white font-medium px-8 py-3 rounded-xl transition-all shadow-sm">
                ...
                <div className="space-y-6">
                    ...
                    {isMixedCategoryCart && (
                        <div className="mt-4 flex items-start gap-3 rounded-xl border border-red-100 bg-red-50 p-4 text-sm font-medium text-fm-rose shadow-sm md:text-base">
                            <svg className="h-6 w-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                            </svg>
                            <p>
                                Il carrello contiene articoli di <strong>sezioni diverse</strong> del catalogo (Tombe, Funerale, Piccoli Amici). Rimuovi i prodotti che non appartengono alla stessa sezione prima di procedere.
                            </p>
                        </div>
                    )}
