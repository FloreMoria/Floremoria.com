...
export const SAAS_FOREIGN_VENDOR_RE =
    /\b(VERCEL|GOOGLE(\s*CLOUD|\s*IRELAND|\s*PAYMENT)?|STRIPE|GITHUB|OPENAI|AWS|AMAZON\s*WEB|META(\s*PLATFORMS)?|FACEBOOK|CURSOR|ANYSPHERE|ANYSILENT|ANTHROPIC|CLAUDE|MICROSOFT|AZURE|CLOUDFLARE|DIGITALOCEAN|HEROKU|NOTION|SLACK|FIGMA|LINEAR|DATADOG|SENTRY|TRANSATEL|UBIGI|TWILIO|ADOBE)\b/i;
